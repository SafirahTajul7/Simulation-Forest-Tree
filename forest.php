					...
					<div class="col-lg-12">
						<table class="table table-bordered table-striped">
                            ...
                            while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
                                ...
                                <td align="left">' . $row['speciesName'] . '</td>
                                <td align="left">' . $row['SpeciesGroup'] . '</td>
                                <td align="left">' . $row['BlockX'] . '</td>
                                <td align="left">' . $row['BlockY'] . '</td>
                                <td align="left">' . $row['Diameter'] . '</td>
                                <td align="left">' . $row['NumberOfLogs'] . '</td>
                                <td align="left">' . $row['StemHeight'] . '</td>
                                ...
                                <td align="left">' . $row['DiameterClass'] . '</td>               
                                </tr>';
                            }
                            ?>
				        </tbody>
